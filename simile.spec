...
source:		simile_6.12.3.tar.gz

BuildRequires:  gcc-c++ >= 4.0, gprolog >= 1.4.0, tcl-devel >= 8.5, tk-devel >= 8.5, gdal-devel >= 1.5 libXcursor-devel >= 1.0
...
%changelog
* Thu Jun 30 2022 Simulistics Ltd <info@simulistics.com> - 6.12-3
- Patch release

* Mon May 09 2022 Simulistics Ltd <info@simulistics.com> - 6.12-2
- Patch release

* Thu Apr 28 2022 Simulistics Ltd <info@simulistics.com> - 6.12-1
- Patch release

* Thu Mar 10 2022 Simulistics Ltd <info@simulistics.com> - 6.12-0
- Minor release

* Wed Jan 19 2022 Simulistics Ltd <info@simulistics.com> - 6.11-15
- Patch release

* Wed Dec 15 2021 Simulistics Ltd <info@simulistics.com> - 6.11-14
- Patch release

* Tue Dec 07 2021 Simulistics Ltd <info@simulistics.com> - 6.11-13
- Patch release

* Wed Nov 17 2021 Simulistics Ltd <info@simulistics.com> - 6.11-12
- Patch release

* Wed Oct 27 2021 Simulistics Ltd <info@simulistics.com> - 6.11-10
- Patch release

* Thu Oct 07 2021 Simulistics Ltd <info@simulistics.com> - 6.11-9
- Patch release

* Wed Aug 11 2021 Simulistics Ltd <info@simulistics.com> - 6.11-8
- Patch release

* Mon Jul 12 2021 Simulistics Ltd <info@simulistics.com> - 6.11-7
- Patch release

* Fri Jul 02 2021 Simulistics Ltd <info@simulistics.com> - 6.11-6
- Patch release

* Thu May 20 2021 Simulistics Ltd <info@simulistics.com> - 6.11-5
- Patch release
...
* Mon Feb 15 2021 Simulistics Ltd <info@simulistics.com> - 6.11-2
- Patch release

* Tue Dec 01 2020 Simulistics Ltd <info@simulistics.com> - 6.11-1
- Patch release

* Tue Oct 20 2020 Simulistics Ltd <info@simulistics.com> - 6.11-0
- Minor release

* Mon Oct 12 2020 Simulistics Ltd <info@simulistics.com> - 6.10-15
- Patch release
