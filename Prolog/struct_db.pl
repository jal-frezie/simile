...
foreign(add_to_course, add_to_course(+string, +integer, +integer)).
foreign(empty_course, empty_course(+string)).
foreign(get_course_pointer, get_course_pointer(+string, -integer)).
