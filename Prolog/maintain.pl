...
:- 	module(maintain, [cursor_in/2, callback/1,
		...
		spread_colour/1, update_color/1,
		give_focus/1, update_do_buttons/2, scrub_run/0, kill_helpers/0,
...
update_do_buttons(Un, Re) :-
	Window shows_model _,
		tk_update_do_menu(Window, Un, Re),
		fail;
