/*
SimileScript
quick and dirty way to build
copy this winMain.c (modified wish) over the tk source winMain.c
copy the wish.res with this file over the tk source wish.res
then build tk
*/
    ...
    Tcl_Interp *interp;		/* Interpreter for application. */
{
	...
	// SimileScript cutomisation
	// hide the toplevel
	Tcl_Eval(interp, "wm withdraw .");
    
	// load SimileAutoObj package and hide the model window
	Tcl_Eval(interp, "package require SimileAutoObj");
