...
if {!$headless && [tk windowingsystem] eq "aqua"} FixMacComboBox
...
proc CheckCompilerLocation {} {
	...
	set compiler [file nativename [file join $env(SYSDIR) bin g++]]
	set possDirs {{}}
    }
...
proc PrintNow {winId} {
	...
	Query windowsPrintFail warning top $winId {ok}
	return

	# previous method using printer package
