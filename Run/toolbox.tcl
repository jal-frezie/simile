...
# puts "Created interp $execInterp($node,id) for $node"
    ...
    foreach stubCmd {load_c_stub_1 c_setparamarray tcl_setparamarray c_getparamall c_gettimepointall PlaceInArray ListToArray InitTimeSeries ResetTimeSeries UpdateTimeSeries SetWrapTime SetFillMethod SetInterval ex_load_dll update_executable ReleaseHandle GetHandle RunningInC GetTclCompExecData GetCompProperty ExScrubRun} {
	if {$useThreads} {
