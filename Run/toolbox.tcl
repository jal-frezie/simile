...
# comment out next two lines for thread free operation
	...
	foreach stubCmd {load_c_stub_1 load_c_stub_2 get_auth_code check_auth_code c_setparamarray c_setparamelement c_cleartimeseries c_setwraparoundtime c_setfillmethod ex_load_dll update_executable free_data_handle GetHandle RunningInC GetTclCompProperty GetCCompProperty ExScrubRun} {
	    proc $stubCmd {args} {
		global execThread
