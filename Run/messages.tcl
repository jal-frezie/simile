...
set msgs(pause_in_pest_exec_message) "PEST tried to run this model up to time %s but it was interrupted at time %s"
set msgs(pause_in_pest_exec_message) "The PEST run has been paused. To continue it, you should first restart the model execution and allow the current model run to complete, then restart PEST execution."
