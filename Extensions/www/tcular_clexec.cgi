...
if {[catch {
    ...
    exec /var/www/similive/webuser/emsdk_portable/emscripten/master/emcc -I [file join $sPath Run] -o [file join $sHome $shLib].asm.js $middle [file join $sPath Run shank.cpp] -O2 -DJOIN_AT_HIP --memory-init-file 0 -Wno-logical-op-parentheses -s EXPORTED_FUNCTIONS=\['_proc_pointers_for_shank','_load_model','_get_node_count','_get_data_line','_name_from_nodlin','_eqn_from_nodlin','_min_from_nodlin','_max_from_nodlin','_class_from_nodlin','_type_from_nodlin','_eval_from_nodlin','_searchinfo','_getNodeId','_fetch_top_instance','_setstep','_use_array_for_params','_get_param_ptr_and_dims','_set_bloc_element','_paste_param_data','_param_array_size','_create_time_point','_get_timepoint_ptr_and_dims','_get_wrap_ptr','_get_fill_ptr','_get_interval_ptr','_reset','_get_raw_values','_ds_from_nodvals','_ct_from_nodvals','_size_from_sznptr','_ptr_from_sznptr','_free_bloc_data','_execute'\] -s RESERVED_FUNCTION_POINTERS=3 -s ASSERTIONS=1 -s ALLOW_MEMORY_GROWTH=1
