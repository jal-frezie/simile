if {[string equal windows $::tcl_platform(platform)]} {
    ...
    namespace eval ArcMap {
        ...
        #version 9
        variable esriArcMapUIkey HKEY_CLASSES_ROOT\\TypeLib\\{40499F24-596F-45D2-ACE1-A251E2990017}\\1.0\\0\\win32
        variable esriArcMapUI_typelib [registry get $esriArcMapUIkey ""]
        variable esriGeoDatabasekey HKEY_CLASSES_ROOT\\TypeLib\\{0475BDB1-E5B2-4CA2-9127-B4B1683E70C2}\\1.0\\0\\win32
        variable esriGeoDatabase_typelib [registry get $esriGeoDatabasekey ""]
        variable esriFrameworkkey HKEY_CLASSES_ROOT\\TypeLib\\{866AE5D3-530C-11D2-A2BD-0000F8774FB5}\\1.0\\0\\win32
        variable esriFramework_typelib [registry get $esriFrameworkkey ""]
        variable esriSystemkey HKEY_CLASSES_ROOT\\TypeLib\\{4ECCA6E2-B16B-4ACA-BD17-E74CAE4C150A}\\1.0\\0\\win32
        variable esriSystem_typelib [registry get $esriSystemkey ""]
        variable esriCartokey HKEY_CLASSES_ROOT\\TypeLib\\{45AC68FF-DEFF-4884-B3A9-7D882EDCAEF1}\\1.0\\0\\win32
        variable esriCarto_typelib [registry get $esriCartokey ""]
        variable esriCatalogUIkey HKEY_CLASSES_ROOT\\TypeLib\\{C0FC1503-7E6F-11D2-AABF-00C04FA375F1}\\1.0\\0\\win32
        variable esriCatalogUI_typelib [registry get $esriCatalogUIkey ""]
        variable esriCatalogkey HKEY_CLASSES_ROOT\\TypeLib\\{ADC7DE29-DC0B-448E-BBF6-27E4E34CF2EC}\\1.0\\0\\win32
        variable esriCatalog_typelib [registry get $esriCatalogkey ""]
        
        proc StartArcMap9 {ref} {
            global Arc_ArcMap
            global Arc_Map
            variable TypeLibLoaded
            
            variable esriArcMapUI_typelib
            variable esriGeoDatabase_typelib
            variable esriFramework_typelib
            variable esriSystem_typelib
            variable esriCarto_typelib
            variable esriCatalogUI_typelib
            variable esriCatalog_typelib
            #set origcursor [.mre cget -cursor]
            #.mre configure -cursor watch
            #set t [toplevel .loadArcmap -bd 4]
            #wm title $t "Starting ArcMap"
            #wm transient $t $dtId
            
            
            if {!$TypeLibLoaded} {
                ::tcom::import $esriArcMapUI_typelib; # ArcMap
                ::tcom::import $esriGeoDatabase_typelib
                ::tcom::import $esriFramework_typelib
                ::tcom::import $esriSystem_typelib
                ::tcom::import $esriCarto_typelib
                ::tcom::import $esriCatalogUI_typelib
                ::tcom::import $esriCatalog_typelib
            }
            
            set Arc_Map($ref) [::esriArcMapUI::MxDocument]; # start ArcMap
            set Arc_ArcMap($ref) [$Arc_Map($ref) -get Parent]; # get a reference to the application
            $Arc_ArcMap($ref) -set Visible True
            # not availablein v9? $Arc_ArcMap($ref) Caption {Simile ArcMap display}
        ...
        proc AddMap9 {ref multiSelect} {
            ...
            # Obtain the object factory interface from the app
            set pObjFactory [::esriFramework::IObjectFactory $Arc_ArcMap($ref)]
            
            # Get a reference to the ArcMap document and the focus map
            set pMxDoc [::esriArcMapUI::IMxDocument $Arc_Map($ref)]
            #set pMap [$pMxDoc FocusMap]
            ...
            # Display the GXDialog to allow user to choose data.
            set puGxDialog [$pObjFactory Create "esriCatalogUI.GxDialog" ]
            set pGxDialog [::esriCatalogUI::IGxDialog $puGxDialog]
            #ShowMessage debug info "pGxDialog $pGxDialog; multiSelect $multiSelect" ok
            $pGxDialog AllowMultiSelect $multiSelect; #0; #$multiSelect # v4
            # v4 try a variable? or different TCom????
            $pGxDialog Title "Load a map"
            
            # Equivalent to Set pGxFilter = New GxFilterFeatureClasses
            set pIUnkown [$pObjFactory Create "esriCatalog.GxFilterMaps"]; # choose file type
            set pGxFilter [::esriCatalog::IGxObjectFilter $pIUnkown]
            set ifc [::esriCatalog::IGxObjectFilterCollection $pGxDialog]
            $ifc AddFilter $pGxFilter 1
            ...
            if {[string match {} $pGxObjects]} {
                ...
                while {![string match {} $pGxDataset]} {
                    ...
                    lappend files [$pGxDataset FullName]
        ...
        proc AddMap {ref multiSelect} {
            ...
            # Equivalent to Set pGxFilter = New GxFilterFeatureClasses
            set pIUnkown [$pObjFactory Create "esriCore.GxFilterMaps"]; # choose file type
            set pGxFilter [::esriCore::IGxObjectFilter $pIUnkown]
            set ifc [::esriCore::IGxObjectFilterCollection $pGxDialog]
            $ifc AddFilter $pGxFilter 1
