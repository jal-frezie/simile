source(program='Simile v7.0',version= 11.0,edition=enterprise,date='Fri May 12 11:53:51 GMT 2023').
...
node(node00166,compartment,[],[complete=true,name=comp1],[caption_offset=[0,0],centre=[76,191]]).
node(node00167,function,[],[complete=true,name=fn4,spec='initial*delay/n',units=1,value=initial*delay/n],[]).
...
node(node00171,function,[],[complete=true,name=fn6,spec='n*comp1/delay',units=1/day,value=n*comp1/delay],[along=550]).
node(node00170,function,[],[complete=true,name=fn5,spec='if index(1)==1 then input else in_preceding(empty)',units=1/day,value=(if index(1)==1 then input else in_preceding(empty))],[along=550]).
...
arc(arc00165,node00168,node00166,flow,[attached=[node00170],complete=true,name=fill],[caption_offset=[0,0],curve=[550,1000]]).
...
arc(arc00167,node00166,node00169,flow,[attached=[node00171],complete=true,name=empty],[caption_offset=[0,0],curve=[550,1000]]).
...
arc(arc00170,node00166,node00171,influence,[attached=[],complete=true,name=i8,role=[use(none,in_hierarchy,comp1,1)]],[curve=[9,5]]).
